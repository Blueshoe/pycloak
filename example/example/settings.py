...
SECRET_KEY = 'django-insecure-_)s=7i1u=s%=*1vc#%!^(kmgg5_+5h0-xsjmh2#z3a^g99_n(8'
...
MIDDLEWARE = [
    ...
    'pycloak.middleware.JWTMiddleware',
...
PYCLOAK_ALGORITHM = None
PYCLOAK_AUDIENCE = None
PYCLOAK_TOKEN_HEADER = "HTTP_AUTHORIZATION"
PYCLOAK_CLIENT_ID = "account"
PYCLOAK_ALLOW_DEFAULT_LOGIN = False
